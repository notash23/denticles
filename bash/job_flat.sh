...
cp -r /scratch/adwarka-denticle/denticles/simulation/airfoil/ /scratch/adwarka-denticle/airfoil_flat/
cd /scratch/adwarka-denticle/airfoil_flat/
...
mv constant/triSurface/airfoil_flat.stl constant/triSurface/airfoil.stl
