...
cp -r /scratch/adwarka-denticle/denticles/simulation/airfoil/ /scratch/adwarka-denticle/airfoil_short/
cd /scratch/adwarka-denticle/airfoil_short/
...
mv constant/triSurface/airfoil_short.stl constant/triSurface/airfoil.stl
